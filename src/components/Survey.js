		...
		<div>
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<FormControl>
					...
					>
						<FormControlLabel
							value="Heavy user (use technology extensively throughout the day)"
							control={<Radio />}
							label="Heavy user (use technology extensively throughout the day)"
						/>
						<FormControlLabel
							value="Moderate user (use technology regularly but not excessively)"
							control={<Radio />}
							label="Moderate user (use technology regularly but not excessively)"
						/>
						<FormControlLabel
							value="Light user (use technology sparingly)"
							control={<Radio />}
							label="Light user (use technology sparingly)"
						/>
						<FormControlLabel
							value="Non-user (rarely use technology)"
							control={<Radio />}
							label="Non-user (rarely use technology)"
						/>
					</RadioGroup>
				</FormControl>
			</Box>
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<FormControl>
					...
					>
						...
						/>
						<FormControlLabel
							value="Breathing device(melo) etc"
							control={<Radio />}
			...
			<Box sx={{ width: 250, p: 2 }}>
				<h4>Question 11</h4>
				<h5>
					Have you used apps with haptic feedback for breathing exercises
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<FormControl>
					<FormLabel id="query14"></FormLabel>
					<RadioGroup
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<FormControl>
					<FormLabel id="query15"></FormLabel>
					<RadioGroup
			...
			<Box sx={{ width: 250, p: 2 }}>
				<h4>Question 16</h4>
				<h5>
					Did the haptic feedback help you stay focused during the breathing
					exercises?
				</h5>
				<Slider
					name="query16"
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<h5>
					{" "}
					Did the haptic feedback enhance or distract from your experience of
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<FormControl>
					<FormLabel id="query18"></FormLabel>
					<RadioGroup
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<h5>
					{" "}
					On a scale of 1 to 5, how likely are you to continue using the version
					of the app with haptic feedback?
				</h5>
				<Slider
					name="query19"
					marks={marksNineteen}
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<FormControl>
					<FormLabel id="query20"></FormLabel>
					<RadioGroup
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<h5>
					{" "}
					If you've used both app versions (with and without haptic feedback),
					which one did you prefer?
				</h5>
				<FormControl>
					<FormLabel id="query21"></FormLabel>
					<RadioGroup
					...
					>
						<FormControlLabel
							value="Version with haptic feedback"
							control={<Radio />}
							label="Version with haptic feedback"
						/>
						<FormControlLabel
							value="Version without haptic feedback"
							control={<Radio />}
							label="Version without haptic feedback"
						/>
						<FormControlLabel
							value="No preference/I haven't used both versions."
							control={<Radio />}
							label="No preference/I haven't used both versions."
						/>
					</RadioGroup>
				</FormControl>
			</Box>
			...
			<Box sx={{ width: 250, p: 2 }}>
				<h4>Question 23</h4>
				<h5>
					If given the option, would you prefer to use the version of the app
					with haptic feedback or without?
				</h5>
				<FormControl>
					<FormLabel id="query23"></FormLabel>
					<RadioGroup
					...
					>
						<FormControlLabel
							value="with haptic feedback"
							control={<Radio />}
							label="with haptic feedback"
						/>
						<FormControlLabel
							value="without haptic feedback"
							control={<Radio />}
							label="without haptic feedback"
						/>
						<FormControlLabel
							value="No preference"
							control={<Radio />}
			...
			<Box sx={{ width: 250, p: 2 }}>
				...
				<h5>
					...
					in the app related to haptic feedback or breathing exercises
				</h5>
				<TextField
					name="query25"
					value={data.query25}
