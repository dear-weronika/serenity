    ...
    return (
        <div>
            ...
            <Box sx={{ width: 250, p: 2 }}>
                <h4>Question 9</h4>
                <h5>
                    Have you used apps with vibration (haptic feedback) for breathing exercises
            ...
            <Box sx={{ width: 250, p: 2 }}>
                <h4>Question 10</h4>
                <h5>What are your overall impressions of the breathing exercises you did a minute ago,
                    specifically regarding the visual graph with the blue bubble?
                </h5>
                <Slider
                    name="query10"
                    marks={marksTen}
            ...
            <Box sx={{ width: 250, p: 2 }}>
                <h4>Question 14</h4>
                <h5>
                    Did the vibration (haptic feedback) help you stay focused during the breathing
                    exercises?
                </h5>
                <Slider
                    name="query14"
            ...
            <Box sx={{ width: 250, p: 2 }}>
                <h4>Question 14a</h4>
                <h5>
                    Did the vibration (haptic feedback) enhanced your experiance during the breathing
                    exercises?
                </h5>
                <Slider
                    name="query14a"
            ...
            <Box sx={{ width: 250, p: 2 }}>
                <h4>Question 15</h4>
                <h5>
                    Did the vibration (haptic feedback) distracted you during the breathing
                    exercises?
                </h5>
                <Slider
                    name="query15"
            ...
            <Box sx={{ width: 250, p: 2 }}>
                <h4>Question 18</h4>
                <h5>
                    Once this app is available how likely are you to continue using the version
                    of the app with vibration haptic feedback?
                </h5>
                <Slider
                    name="query18"
                    marks={marksEighteen}
            ...
            <Box sx={{ width: 250, p: 2 }}>
                <h4>Question 20</h4>
                <h5> Do you have any suggestions for improving the vibration (haptic feedback)</h5>
                <TextField
                    name="query20"
                    value={data.query20}
                    onChange={handleChange}
